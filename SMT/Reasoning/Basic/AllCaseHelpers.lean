...
/-!
# Helper lemmas for representation-aware forall encoding

This file collects lemmas specialized for the representation-aware
forall-quantifier cases. Key additions:
