...
BEer still fails).  Dropping from 8 to 2 gains 5 goals against 1 lost on one
sample, and 6 against none on the other, and takes the median per-goal script
from 245 KB to 208 KB. -/
